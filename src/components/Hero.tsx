...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen pt-20 sm:pt-28 md:pt-36 pb-16 sm:pb-20 md:pb-24 overflow-hidden bg-gradient-to-br from-background via-background to-muted/5">
